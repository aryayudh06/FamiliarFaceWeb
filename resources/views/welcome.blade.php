...
<body class="bg-[#771D1F] text-white flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-6 py-2 text-white bg-[#654321] hover:bg-[#7a5634] rounded-full text-lg font-semibold transition ease-in-out duration-150">
                        Login
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="inline-block px-6 py-2 text-[#1b1b18] bg-[#f0e68c] hover:bg-[#f5eead] rounded-full text-lg font-semibold transition ease-in-out duration-150">
                            Register
                        </a>
                    @endif
                @endauth
    ...
    <div
        ...
        <main class="flex flex-col items-center justify-center text-center">
            <h1 class="text-6xl font-serif mb-4">FamiliarFace</h1>
            <p class="text-xl font-serif">Recognize Yourself.</p>
        </main>
    </div>
</body>
